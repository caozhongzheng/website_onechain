...
exports.post = function*() {
	...
	if (this.request.query.method == 'edit') {
		try {
			...
			console.log("czz edit rule args:", args)
			console.log("czz edit rule result:",result)
	...
	try {
		...
		console.log("czz create rule args:", args)
		console.log("czz create rule result:", result)
